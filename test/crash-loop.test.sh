#!/usr/bin/env bash
#
# test/crash-loop.test.sh — a fleet-wide Co-Ordinator crash loop is detected
# once and escalated once (requirement 2.7, acceptance check 5a).
#
...
#
# No network: both functions are pure readers of an event stream on stdin.
#
