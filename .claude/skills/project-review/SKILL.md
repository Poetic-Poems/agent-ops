...
- In the Claude.ai chat: present the output folder's files with the file-presentation tool, index first, plus the updated `TECH-DEBT.md` (and, for a per-item register, any new or updated `tech-debt/*.md` files).
